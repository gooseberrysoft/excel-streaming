...
internal sealed class PngInfoReader : ImageInfoReader
{
    ...
    protected override PictureInfo ReadInfo(Stream stream)
    {
        ...
        return new PictureInfo(PictureFormat.Png, width, height, dpiX, dpiY);
    }

    private static uint ReadType(Stream stream)
        => stream.ReadU32BE();
